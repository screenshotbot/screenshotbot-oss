...
(build-utils:jar-file "jersey-client-3.0.2")
...
(build-utils:jar-file "jackson-databind-2.10.3")
(build-utils:jar-file "jackson-core-2.10.3")
(build-utils:jar-file "jackson-annotations-2.10.3")
...
(build-utils:jar-file "jersey-common-3.0.2")
(build-utils:jar-file "jakarta.ws.rs-api-3.0.0")
(build-utils:jar-file "jakarta.inject-api-2.0.0")
...
(build-utils:jar-file "jakarta.annotation-api-2.0.0")
