    ...
    <settings-template>
      <form action=save method= "POST">
        <div class= "card mt-3">
          ...
          <div class= "card-body" >
            <p class= "text-muted" >By default, we send notifications to every user on the account. You can control whether eyou account should receive emails on this page.</p>
