  ...
  (setf (hunchentoot:header-out "Content-Security-Policy")
        (format nil "~{~a~^; ~}"
                `("default-src 'self'"
                  ...
                  "frame-src 'self' https://www.youtube.com https://assets.calendly.com https://embed-v2.testimonial.to https://www.googletagmanager.com https://app.hubspot.com https://meetings.hubspot.com https://*.cookiebot.com https://js.hsforms.net"
