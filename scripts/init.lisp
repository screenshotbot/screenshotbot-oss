...
#+screenshotbot-oss
(progn
  (quick-patch:register "https://github.com/moderninterpreters/markup" "origin/master")
  (register-tdrhq "easy-macros" "origin/main")
  (register-tdrhq "fiveam-matchers" "origin/master"))
